...
//Route::middleware('Auth:student')->group(function () {
    ...
    Route::post('/livrestore', 'BorrowerController@storeStudent')->name('borrower.student');

//});
// routes/web.php

// Route pour afficher le formulaire de connexion
Route::get('/loginStudent', [StudentController::class, 'showLoginForm'])->name('loginStudent');

// Route pour traiter la connexion
Route::post('/loginStudent', [StudentController::class, 'login']);

// Route pour déconnecter l'étudiant
Route::post('/logoutStuent', [StudentController::class, 'logout'])->name('logoutStudent');
...
#livreUsers
Route::get('/livre','BookController@indexUsers')->name('livres');
